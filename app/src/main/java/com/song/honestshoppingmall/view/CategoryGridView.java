...
import com.song.honestshoppingmall.fragment.GoodsListFragment;
    ...
    public void addOnItemClickListener(){
        this.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putInt("cId", mThirdPartList.get(position).getId());

                ((HomeActivity) getContext()).changeFragment(new GoodsListFragment(), "GoodsListFragment", bundle);
            }
        });
    }
