...
public class RotateHotsaleVpAdapter extends PagerAdapter {

    private Context context;
    private LayoutInflater mInflater;
    private List<RotateBean> datas;

    public RotateHotsaleVpAdapter(List<RotateBean> datas, Context context) {
        this.datas = datas;
        this.context = context;
        mInflater = LayoutInflater.from(context);
    }

    public RotateHotsaleVpAdapter(Context context) {
        this.context = context;
        mInflater = LayoutInflater.from(context);
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        textView.setText("促销" + newPosition);
